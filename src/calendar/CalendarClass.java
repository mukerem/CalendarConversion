...
public class CalendarClass  {
	...
	public void menu(){
		...
		GregoriaCalendar object2 = new GregoriaCalendar();
	...
	//Month of year in hijri calendar
		...
		public void listOfYearInHijri(){
			...
			comboBox_3.setFont(new Font("Tw Cen MT", Font.BOLD | Font.ITALIC, 16));
			comboBox_3.setBounds(56, 28, 63, 20);
	...
	public void buttons(){
		...
		btnShow.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				GregoriaCalendar goregorianobject = new GregoriaCalendar(); // creating object for Goregorian calendarr
				if(calendarchoice == 1){
